...
$('submit').click(function () {
 ...
 <!--  <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script> -->
 	...
 	<form action="changerecruiter.do" method="post" class="form-signin">
		<p>
			...
			Confirm Password:<input type="password" class="form-control" name="confirmpassword"  id="confirm_password" placeholder="confirm password" required=""/>
		<br><br>	
